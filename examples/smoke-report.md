# Portable Prover Rating — development smoke test

**This public, small task bank validates the implementation. Its separated outcomes do not establish a calibrated public rating for AgdaProver.**

Track: `agda-intensional-without-K-exact-split-v1`; budget: 10.0 seconds; anchor: lambda-baseline-v1 = 1500.
...
| --- | ---: | --- | ---: |
| AgdaProver-d2b0d7c | 2138 | unavailable | 68.8% |
...
| --- | ---: | ---: | ---: | ---: |
| AgdaProver-d2b0d7c | 75.0% | 100.0% | 0.0% | 100.0% |
...
Results fingerprint: `57e25ef241dff0477845a19e7b1479bce8cc809f21da4de32706b79e7a048d01`.
